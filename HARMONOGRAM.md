...
| :------------- | :--------------- | :-------------- | :------------------ | :-------------- |
| **PROGRAM_01** | **3 499 PLN**    | **17 495 PLN**  | **4 299 PLN**       | **21 495 PLN**  |
| **PROGRAM_02** | **4 999 PLN**    | **24 995 PLN**  | **5 999 PLN**       | **29 995 PLN**  |
| **PROGRAM_03** | **5 999 PLN**    | **29 995 PLN**  | **7 199 PLN**       | **35 995 PLN**  |
...
## 🛠️ SPECYFIKACJA_SYSTEMU

### [01] PROTOKÓŁ_LIVE (Deep Work)

- 2 sesje tygodniowo po 120 minut (Live Coding).
- Realne debugowanie Twojego kodu i budowa systemów produkcyjnych.

### [02] SQUAD_MODE (Elita 5–10 osób)

- Małe grupy operacyjne. Ścisły limit miejsc gwarantujący jakość mentoringu.

### [03] INDIVIDUAL_MODE (Face-to-Face)

- Pełna personalizacja ścieżki i tempa pracy pod Twoje cele biznesowe.

### [04] INFRASTRUKTURA_I_SUWERENNOŚĆ

- **Platforma SYNC:** Nagrania, dokumentacja, bazy wiedzy.
- **Repozytoria:** Autorski stos mikroserwisów (PydanticAI, MCP, Qdrant) przechodzi na Twoją własność.
- **Zero SaaS:** Budujemy suwerenność technologiczną bez uzależnienia od zewnętrznych dostawców.

---

## ✅ PODSUMOWANIE_OPERACYJNE

- **Długofalowość:** 20 tygodni intensywnej transformacji (5 miesięcy).
- **Merytoryka:** 12 zaawansowanych modułów na każdy program.
- **Podejście:** Code-First. No-heavy-abstraction.
- **Wynik:** Autorskie portfolio i całkowita niezależność w budowie zaawansowanych systemów AI.
